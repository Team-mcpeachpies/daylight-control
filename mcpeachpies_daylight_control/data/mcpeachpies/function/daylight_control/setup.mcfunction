...
scoreboard objectives add time_converter trigger ["",{"text":"Real Time Converter","color":"blue"}]
scoreboard objectives add time_speed_percentage trigger ["",{"text":"time_speed_percentage Custom Gamerule","color":"blue"}]
scoreboard objectives add time_speed_24_hours trigger ["",{"text":"24 Hour Days","color":"blue"}]

scoreboard players set mpp_daylight_setup mpp_datapacks 1

scoreboard players set value_2000 mpp_daylight_count 2000
scoreboard players set time_speed_percentage mpp_daylight_count 100
...
scoreboard objectives remove daylightConverter
scoreboard objectives remove daylightSpeedPercentage
scoreboard objectives remove daylightSpeed24hours